        ...
        <div class="productss" >
                <div class="product" v-for="product in products" :key="product.id" v-if="product.show===true">
                    ...
                    <div id="content"> 
                        ...
                        <div>
                            <br>
                            <span v-for="n in product.rating" :key="n*2"><i class="fa-solid fa-star"></i></span>
                            <span v-for="n in 5-product.rating" :key="n*3"><i class="fa-regular fa-star"></i></span> 
                        </div>
...
export default{
    name:"ProductList", //name of component
    ...
    methods: {
        //adding products event trigger
      addProduct(product){
        this.$emit('addProduct',product);
      },
    //   checking if quantity is over
      canAdd(product){
        return product.
                quantity!=0 
      },
